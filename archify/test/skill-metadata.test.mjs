...
test('language behavior stays within the bounded locale contract', () => {
  ...
  assert.match(authoringContract, /Do not silently substitute\s+`zh-CN` or `ja` for another language/);
  assert.match(authoringContract, /never treat Japanese and Chinese as\s+interchangeable/);
